...
/**
 * 代码拷贝自org.apache.poi.xssf.eventusermodel.XSSFSheetXMLHandler
 * 见 https://svn.apache.org/repos/asf/poi/trunk/src/ooxml/java/org/apache/poi/xssf/eventusermodel/XSSFSheetXMLHandler.java
 * 已稍作修改
 * 
 */
public class DefaultSheetXMLHandler extends DefaultHandler {
    private static final POILogger logger = POILogFactory.getLogger(DefaultSheetXMLHandler.class);
       ...
       if (isTextTag(name)) {
           ...
           switch (nextDataType) {
                   ...
                   if(formulasNotResults) {
                      ...
                      if (this.formatter != null) {
                         try {
                            ...
                            thisStr = this.formatter.formatCellNumberValue(d, this.formatIndex, this.formatString);
               ...
               case INLINE_STRING:
                   ...
                   if (this.formatter != null) {
                	   thisStr = this.formatter.formatCellTextValue(thisStr);
                   }
                   break;
               ...
               case NUMBER:
                   ...
                   if (n.length() > 0 && this.formatter != null)
                       thisStr = this.formatter.formatCellNumberValue(Double.parseDouble(n), this.formatIndex, this.formatString);
                   else
                       thisStr = n;
                   break;
